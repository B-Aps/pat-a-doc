...
<nav>
<div class="logo">
<a href="Navdoctor.jsp"><img src="./img/logo2.png"></a>
<ul>
...
try
{
 ...
 ResultSet rs=st.executeQuery("Select count(*) from sathya.patientdet");
 while(rs.next())
 {%>
     <br><br><br><br><h1>Your Credits(Rs.200 per client): <br>Rs.<%out.print(rs.getInt(1)*200);%></h1>               
 <%}%>
